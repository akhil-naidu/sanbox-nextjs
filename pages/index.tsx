  ...
  return (
    <Fragment>
      ...
      <header className="wrapper bg-soft-primary">
        <Navbar
          logoAlt="logo-purple"
          button={<NextLink title="Read Docs" href="/docs" className="btn  btn-primary rounded-pill" />}
        />
      </header>
        ...
        <div className="container pt-xl-10 text-center">
          <div className="row">
            <div className="col-md-10 col-lg-9 col-xl-8 col-xxl-7 mx-auto">
              ...
              <a href="/docs" target="_blank" className="btn btn-lg btn-primary rounded-pill mb-10" rel="noreferrer">
                Use Sandbox
              </a>
            </div>
          </div>
